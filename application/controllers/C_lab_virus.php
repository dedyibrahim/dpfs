...
foreach($query->result_array() as $cetak);{
     ...
     $html = str_replace('{bakteri_ditemukan}',$cetak['virus_ditemukan'],$html);
     $html = str_replace('{jumlah_bakteri}',$cetak['jumlah_virus'],$html);
     
     $html = str_replace('{organ_target}',$cetak['nekropsi_virus'],$html);
