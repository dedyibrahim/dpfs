...
<div class="x_panel">
 ...
 <form action="<?php echo base_url('C_lab_jamur/simpan')?>" method="post" enctype="multipart/formdata">
    <h2>Buku Nekropsi</h2>
    <a href="<?php echo base_url()?>C_lab_jamur/lhus/<?php echo $data['record_number_customer'];?>"><button type="button" class="btn btn-primary fa fa-print pull-right"> CETAK LHUS</button></a>
...
<div class="col-md-6">
   ...
   <di<div class="col-md-6">  
     <div class="form-group">
        ...
        <input type="text"  value ="<?php echo $data['nekropsi_jamur'];?>"  readonly="" class="form-control" placeholder="Organ Target">
       </div>
    
 <div class="form-group">
        <label>Jamur Yang Di temukan</label>
        <input type="text" value ="<?php echo $data['jamur_ditemukan'];?>" name="jamur_ditemukan" class="form-control" placeholder="Jamur Yang ditemukan">
       </div>
    
    <div class="form-group">
        <label>Jumlah Jamur</label>
        <input type="text" value ="<?php echo $data['jumlah_jamur'];?>" name="jumlah_jamur"  class="form-control" placeholder="Jumlah Jamur">
       </div>
...
<div class="x_panel">
        <div class="x_content">
          ...
          <div class="col-xs-2 pull-right">
              <button type="submit" name="btn_jamur" class="btn btn-primary btn-block btn-flat">Simpan</button>
            </form>
          </div>
        </div>
</form>
