...
<div class="item active">
    <a href=""><img style="height:300px; width:350px; " src="<?php echo base_url('uploads/produk_thumb/'.$produk['gambar0']) ?>" alt=""></a>
</div>

<div class="item">
<a href=""><img style="height:300px; width:350px; " src="<?php echo base_url('uploads/produk_thumb/'.$produk['gambar1']) ?>" alt=""></a>
</div>

<div class="item">
<a href=""><img style="height:300px; width:350px; " src="<?php echo base_url('uploads/produk_thumb/'.$produk['gambar2']) ?>" alt=""></a>
</div>
<div class="item">
<a href=""><img style="height:300px; width:350px; " src="<?php echo base_url('uploads/produk_thumb/'.$produk['gambar3']) ?>" alt=""></a>
</div>
