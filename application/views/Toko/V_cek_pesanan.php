...
<?php echo $konfirmasi_pembayaran['status_penjualan']; ?>                     
<div class="row bs-wizard" style="border-bottom:0;">
 ...
 <?php } else { ?> 
                    <h3 align="center" style="color:#f60;">
                        <span class="fa fa-refresh "></span> pesanan anda di tolak dengan alasan<br><?php echo $konfirmasi_pembayaran['alasan_penolakan']; ?><br>Saldo akan dimasukan kedalam  E-cash anda
