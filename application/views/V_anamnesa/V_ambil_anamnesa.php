     ...
     <div class="col-md-6">
       ...
       <div class="form-group">
        ...
        <div class="form-group">
         ...
         <input  name="pelaksana1"  value="<?php echo $data['pelaksana1'];?>"type="text" class="form-control" placeholder="Pelaksana sampling 1">
        </div> 
         
         <div class="form-group">
           <label>Pelaksana sampling 2</label>
           <input  name="pelaksana2" value="<?php echo $data['pelaksana2'];?>" type="text" class="form-control" placeholder="Pelaksana sampling 2">
