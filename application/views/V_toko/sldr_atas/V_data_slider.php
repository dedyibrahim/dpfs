<div class="x_panel">
<div class="x_title">
   <h2>Tambahkan Layout slider atas</h2>
     <div class="clearfix"></div>
                  </div>
<form action="<?php echo base_url('C_toko/sldr_atas') ?>" method="post" enctype="multipart/form-data">
   
     <div class="col-md-6">
        <div class="form-group has-feedback">
            <textarea  class="form-control" name="teks" placeholder="keterangan"></textarea>
      ...
      <div class="form-group has-feedback">
         ...
         <div class="x_content">
          ...
          <div class="col-xs-2 pull-right">
              <button type="submit" name="btnsldratas" class="btn btn-success"><span class="fa fa-save"></span> Simpan</button>
          </div>
        </div>
</div>     
   <div class="col-md-6">
...
<script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#tabel").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?php echo base_url('C_toko/data_json_sldr_atas') ?> ", "type": "POST"},
                    columns: [
                        {
                            "data": "id_slider_atas",
                            "orderable": false
