...
<div class="x_panel">
<div class="x_title">
<h2>MEMBUAT PERMUTASIAN DARI TOKO KE PABRIK</h2>
...
&nbsp;<button name="btnPabrik" class="btn-primary btn btn-md" type="submit"><span class="fa fa-print"></span> CETAK LAPORAN</button>  
</div>
</form>   
</div>
...
processing: true,
serverSide: true,
ajax: {"url": "<?php echo base_url('C_produk/data_json_mut_toko_pabrik') ?> ", "type": "POST"},
columns: [
{
"data": "id_mut_toko_pabrik",
"orderable": false
},
{"data": "id_mut_toko_pabrik"},
{"data": "nama_produk"},
...
<th class="sorting"align="center"  aria-controls="datatable-fixed-header" rowspan="1" colspan="1" style="width: 100px;" aria-label="Name: activate to sort column descending">Stok Pabrik sekarang</th>
