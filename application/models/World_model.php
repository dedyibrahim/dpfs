...
class World_model extends CI_Model {
    ...
    function json() {
        ...
        $this->datatables->join('jenis_sample','jenis_sample.record_number_sample = customer_fpps.record_number_customer');
         $this->datatables->add_column('view','<a class="btn btn-sm btn-warning btn fa fa-edit" href="'.base_url().'C_fpps/edit/$1"></a>| <a class="btn btn-sm btn-danger fa fa-minus" href="'.base_url().'C_fpps/hapus_fpps/$1"></a> <a class="btn btn-sm btn-success  fa fa-print "  href="'.base_url().'C_fpps/data_cetak/$1"></a>', 'record_number_customer'); 
