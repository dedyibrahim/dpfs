...
class Data_nekropsi extends CI_Model {
    ...
    function json() {
        ...
        $this->datatables->add_column('view','<a class="btn btn-xs btn-warning btn" href="'.base_url().'C_nekropsi/ambil_data/$1">Get</a>| <a class="btn btn-xs btn-success" href="'.base_url('C_/').'cetak_anamnesa/$1">Print</a>', 'record_number_customer');
