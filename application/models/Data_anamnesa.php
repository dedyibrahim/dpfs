...
class Data_anamnesa extends CI_Model {
    ...
    function json() {
        $this->datatables->select('record_number_customer,jenis_sample.record_number_sample as record ,customer.nama_customer as nama,jenis_sample.data_sample as sample,jenis_sample.tgl_penerimaan as tgl_terima,jenis_sample.jumlah_sample as jml_sample,jenis_sample.data_sample as sample,'
