...
class Data_mutasi extends CI_Model {
    ...
    function json_mut_pabrik_toko() {
        $this->datatables->select('mut_pabrik_toko.id_mut_pabrik_toko,'
                ...
                . 'mut_pabrik_toko.status_konfirmasi as status,'
                );
        ...
        $this->datatables->add_column('view','<a class="btn btn-sm btn-success fa fa-check " href="'.base_url().'C_pengaturan/konfirmasi_pabrik_toko/$1"></a> || <a class="btn btn-sm btn-danger fa fa-trash " href="'.base_url().'C_pengaturan/hapus_mut_pabrik_toko/$1"></a>', 'id_mut_pabrik_toko');
    ...
    function json_mut_toko_pabrik() {
        $this->datatables->select('mut_toko_pabrik.id_mut_toko_pabrik,'
                ...
                . 'mut_toko_pabrik.status_konfirmasi as status,'
        ...
        $this->datatables->add_column('view','<a class="btn btn-sm btn-success fa fa-check " href="'.base_url().'C_pengaturan/konfirmasi_toko_pabrik/$1"></a> || <a class="btn btn-sm btn-danger fa fa-trash " href="'.base_url().'C_pengaturan/hapus_mut_toko_pabrik/$1"></a>', 'id_mut_toko_pabrik');
        return $this->datatables->generate();
       
    }
    function json_mut_pabrik_toko_produk() {
        $this->datatables->select('mut_pabrik_toko.id_mut_pabrik_toko,'
                . 'data_produk_ditoko.nama_produk as nama_produk,'
                . 'mut_pabrik_toko.mut_stok_pabrik as stok,'
                . 'data_produk_ditoko.stok_toko as stok_toko,'
    ...
    function json_mut_toko_pabrik_produk() {
        $this->datatables->select('mut_toko_pabrik.id_mut_toko_pabrik,'
                . 'data_produk_dipabrik.nama_produk as nama_produk,'
                . 'mut_toko_pabrik.mut_stok_toko as stok,'
                . 'data_produk_dipabrik.stok_pabrik as stok_pabrik,'
